    ...
    return (
        ...
        <div className="flex flex-col rounded-lg shadow-lg items-center">
            ...
            <article className="prose prose-lg text-white" >
                ...
                <h2 className="text-[#6e3df5]">Technology behind the site</h2>
                ...
                <h2 className="text-[#6e3df5]">Cloud-Hosting</h2>
                ...
                <h4 className="text-[#6e3df5]">Architecture</h4>
                ...
                <h2 className="text-[#6e3df5]">Future Plans</h2>
                ...
                <h2 className="text-[#6e3df5]">Read this far?</h2>
